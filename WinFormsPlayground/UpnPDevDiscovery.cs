...
";
        ...
        private const string DefaultDeviceType = "roku:ecp"; // "ssdp:all";

        private int searchTimeOut = 15; //Seconds
        ...
        public void FindDevices()
        {
            ...
            var t = new System.Timers.Timer(TimeSpan.FromSeconds(this.searchTimeOut + 1).TotalMilliseconds);
            t.Elapsed += (e, s) => {
                socket.Dispose();
                socket = null;
                t.Stop();
